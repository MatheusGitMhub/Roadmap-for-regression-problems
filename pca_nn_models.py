...
# =======================================================================
# Arquitectura 2 (ocupar esta arquitectura con PCA antes)
# =======================================================================
# Hiperparámetros de la red
batch_size = 60
epochs = 110
...
# errors = pd.read_csv('training_results/summary_PCA_NN_models.csv')
...
# errors.to_csv('training_results/summary_PCA_NN_models.csv')